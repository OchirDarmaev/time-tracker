      ...
      <div class="space-y-3">
        ...
        <div>
          ...
          <div class="flex items-baseline gap-2 flex-wrap">
            ...
            <span
              class="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-medium bg-transparent text-transparent pointer-events-none"
              >⚠ Mismatch</span
            >
          </div>
        </div>
        ...
        <div class="pt-1 border-t border-gray-200 dark:border-gray-700">
          ...
          <div class="flex items-baseline gap-2 flex-wrap">
            ...
            <span
              class="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-medium bg-gray-100 dark:bg-gray-900/30 text-gray-400 dark:text-gray-600"
            >
              No overtime
            </span>
          </div>
