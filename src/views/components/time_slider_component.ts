...
class TimeSliderComponent extends HTMLElement {
  ...
  private render(): void {
    ...
    this.innerHTML = `
      <div id="time-slider-container" class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-6 shadow-sm my-6 w-full max-w-full box-border">
        <div class="flex justify-between items-center mb-6">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 m-0">Daily Time Allocation</h3>
          <div class="flex items-center gap-4">
            <div id="time-slider-sync-status" class="flex items-center gap-2 mr-3">
              <span id="time-slider-sync-icon" class="text-sm text-green-500 dark:text-green-400">Synced</span>
            </div>
            <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 font-medium">
              Total Hours:
              <input 
                type="number" 
        ...
        <div class="relative my-8">
          <div id="time-slider-track" class="relative h-20 bg-gradient-to-r from-gray-200 via-teal-50/5 to-gray-200 dark:from-gray-700 dark:via-teal-900/5 dark:to-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 overflow-visible cursor-pointer">
        ...
        <div class="mt-8 pt-6 border-t border-gray-300 dark:border-gray-700">
          <div class="mb-3">
            <span class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Available Projects</span>
          </div>
        ...
        <div id="time-slider-segments-info" class="mt-6 pt-6 border-t border-gray-300 dark:border-gray-700">
